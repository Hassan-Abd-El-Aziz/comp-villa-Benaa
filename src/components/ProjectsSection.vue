...
const projects = [
  ...
  { id: 4, name: 'Crescent Bay Resort', location: 'Doha, Qatar', type: 'Hospitality', area: '120,000 m²', status: 'Completed', image: 'https://images.unsplash.com/photo-1571896349842-33c89424de2d?q=80&w=2080&auto=format&fit=crop' },
